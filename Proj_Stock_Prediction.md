...
### Data Exploration
In this project, we build a model which can predict TAIEX (like SP500 in US) in Taiwan Stock market. There are 7 items which has been collected as input features. It cover daily price from 2015/02/02 to 2018/01/19. The data are all collected from [1]. 
Collected input feature:
--	TAIEX Close Price
--	TAIEX Volume
--	TAIEX Dealer
--	TAIEX Investment
--  Foreign Investment
--	Option Pull/Call Ratio

The intuition for the input features selection is that the TAIEX index is major dominated by the three major institutions, which is Investment, Foreign and Dealer.
...
Fig. 1 is Close Price and Foreign Investment vs. time. Take a look at the time period from 2015/5 to 2015/6. Foreign institution shows a sell volume (negative value) and the close price show a drop tendency. 
